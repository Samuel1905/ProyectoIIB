 ...
 * @author Flavio
 */
public class GUIEliminarProductos extends javax.swing.JFrame {

    /**
     * Creates new form GUIEliminarProductos
     */
    public GUIEliminarProductos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIEliminarProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIEliminarProductos().setVisible(true);
            }
        });
    }
